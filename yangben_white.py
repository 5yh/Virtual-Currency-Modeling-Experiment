...
real_data = pd.read_csv('/mnt/blockchain0/after_sort/x_train_new.csv')
real_data=real_data.head(20000)
print(real_data)
...
synthetic_data.to_csv('/mnt/blockchain0/after_sort/white_augmentation/x_train_zengqiang.csv')