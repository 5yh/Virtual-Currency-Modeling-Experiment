...
for i in range(1):
  ...
  model.dump_model("/mnt/blockchain0/after_sort/bestModel/model_best.txt")
  model.save_model('/mnt/blockchain0/after_sort/bestModel/origin_model_best.json')
